...
func TestGateSSEIntegration(t *testing.T) {
	...
	err = nodeCluster.PushMessageToClient(ctx, []string{regEvent.ClientID}, testMessage)
	if err != nil {
...
func TestSSEMultipleClients(t *testing.T) {
	...
	for i, client := range clients {
		...
		err = nodeCluster.PushMessageToClient(ctx, []string{client.clientID}, testMessage)
		if err != nil {

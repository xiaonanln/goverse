...
func TestNode_DeleteObject_PersistentObject(t *testing.T) {
	...
	err := node.createObject(ctx, "TestPersistentObject", "delete-obj-1", 0)
	if err != nil {
	...
	// Delete the object
	err = node.DeleteObject(ctx, "delete-obj-1", 0)
	if err != nil {
...
func TestNode_DeleteObject_NonPersistentObject(t *testing.T) {
	...
	err := node.createObject(ctx, "TestNonPersistentObject", "non-persist-obj", 0)
	if err != nil {
		t.Fatalf("Failed to create object: %v", err)
	}
	...
	// Delete the object
	err = node.DeleteObject(ctx, "non-persist-obj", 0)
	if err != nil {
...
func TestNode_DeleteObject_NoProvider(t *testing.T) {
	...
	// Create a persistent object
	err := node.createObject(ctx, "TestPersistentObject", "no-provider-obj", 0)
	if err != nil {
		t.Fatalf("Failed to create object: %v", err)
	}
	...
	err = node.DeleteObject(ctx, "no-provider-obj", 0)
	if err != nil {
...
func TestNode_DeleteObject_NotFound(t *testing.T) {
	...
	err := node.DeleteObject(ctx, "non-existent-obj", 0)
	if err != nil {
...
func TestNode_DeleteObject_MultipleObjects(t *testing.T) {
	...
	// Delete one object
	err = node.DeleteObject(ctx, "multi-obj-3", 0)
	if err != nil {
		t.Fatalf("Failed to delete object: %v", err)
	}
	...
	err = node.DeleteObject(ctx, "multi-obj-1", 0)
	if err != nil {
...
func TestNode_DeleteObject_ThreadSafety(t *testing.T) {
	...
	for i := 0; i < objectCount; i++ {
		go func(idx int) {
			...
			_ = node.DeleteObject(ctx, objID, 0)
			done <- true
		}(i)
	}
